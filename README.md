...
**⚠️ IMPORTANT: Secure your API keys!**

The application uses Groq API for AI features. You must configure your API key securely:
...
2. Edit `.env` and add your Groq API key:
   ...
   ```
3. Get your key from: [Groq Console](https://console.groq.com/keys)
...
**📖 Detailed Setup Guide:** See `SECURITY_SETUP.md` for complete instructions.

### Environment Variables

- `GROQ_API_KEY`: Groq API key for llama-3.1-8b-instant model (REQUIRED)
...
**Requirements**:
- Groq API key (see Configuration section above)
...
- `groq>=0.4.0`: Groq API client for AI features
...
3. **AI Features Not Working**
   - Check Groq API key is configured (see `SECURITY_SETUP.md`)
   - Verify internet connectivity for Groq API access
